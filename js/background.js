...
/*
  Hot reload
  This code is from https://raw.githubusercontent.com/xpl/crx-hotreload/master/hot-reload.js
*/
...
chrome.management.getSelf(self => {
  if (self.installType === 'development') {
    chrome.runtime.getPackageDirectoryEntry().then(dir => watchChanges(dir))
